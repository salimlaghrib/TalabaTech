...
const announcements: Record<number, AnnouncementData> = {
  // Offer room
  1: { id: 1, type: "offer-room", title: "Chambre meublée près FST", description: "Chambre privée dans un appartement partagé, ambiance calme et studieuse. L'appartement est situé à 5 minutes à pied de la FST. Cuisine équipée partagée, salle de bain privée. Internet haut débit (fibre optique).", city: "Errachidia", price: "750 MAD/mois", housingType: "Chambre", images: ["https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=800&q=80", "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=800&q=80", "https://images.unsplash.com/photo-1493809842364-78817add7ffb?auto=format&fit=crop&w=800&q=80"], authorName: "Youssef B.", authorImage: "photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=100&q=80", authorPhone: "0600123456", posted: "il y a 2h", tags: ["Wi-Fi", "Meublé", "Cuisine"], gender: "Homme", bedrooms: 3, bathrooms: 1, surface: 80, furnished: true, currentRoommates: 2, maxRoommates: 3, address: "Rue Hassan II, quartier FST", availableFrom: "Disponible immédiatement" },
  ...
  // Provider listings
  20: { id: 20, type: "provider-listing", title: "Appartement F3 meublé centre", description: "Bel appartement de 3 pièces, entièrement meublé et équipé. Idéal pour 2-3 étudiants. Situé au centre-ville avec toutes les commodités à proximité.", city: "Errachidia", price: "2000 MAD/mois", housingType: "Appartement", images: ["https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=800&q=80", "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=800&q=80", "https://images.unsplash.com/photo-1493809842364-78817add7ffb?auto=format&fit=crop&w=800&q=80"], authorName: "Agence ImmoPlus", authorImage: "photo-1560179707-f14e90ef3623?auto=format&fit=crop&w=100&q=80", authorPhone: "0600567890", posted: "il y a 3j", tags: ["Meublé", "Parking", "AC"], bedrooms: 3, bathrooms: 1, surface: 95, furnished: true, address: "Centre-ville, Avenue Mohammed V", availableFrom: "Disponible immédiatement" },
  21: { id: 21, type: "provider-listing", title: "Chambre privée avec balcon", description: "Chambre individuelle dans résidence sécurisée, avec balcon et vue dégagée. Quartier calme.", city: "Errachidia", price: "1500 MAD/mois", housingType: "Chambre", images: ["https://images.unsplash.com/photo-1493809842364-78817add7ffb?auto=format&fit=crop&w=800&q=80", "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=800&q=80"], authorName: "Omar H.", authorImage: "photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=100&q=80", authorPhone: "0600678901", posted: "il y a 5j", tags: ["Sécurisé", "Balcon"], bedrooms: 1, bathrooms: 1, surface: 30, furnished: false, address: "Quartier El Massira", availableFrom: "1er Avril 2025" },
  22: { id: 22, type: "provider-listing", title: "Maison pour étudiants", description: "Grande maison 5 chambres, jardin, parking. Idéale pour groupe d'étudiants.", city: "Errachidia", price: "4000 MAD/mois", housingType: "Maison", images: ["https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=800&q=80", "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=800&q=80", "https://images.unsplash.com/photo-1493809842364-78817add7ffb?auto=format&fit=crop&w=800&q=80"], authorName: "Propriétaire Direct", authorImage: "photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=100&q=80", authorPhone: "0600789012", posted: "il y a 1 sem", tags: ["Jardin", "Parking", "5 chambres"], bedrooms: 5, bathrooms: 2, surface: 200, furnished: false, address: "Route de Tinghir", availableFrom: "Disponible immédiatement" },
};
...
function saveContact(a: AnnouncementData) {
  try {
    ...
    const alreadyExists = stored.some((c) => c.id === a.id);
    if (!alreadyExists) {
      stored.unshift({
        id: a.id,
        name: a.authorName,
        avatar: a.authorImage,
        online: false,
        lastMessage: `À propos : ${a.title}`,
        time: "maintenant",
        unread: 0,
      });
    ...
    return (
      <div className="min-h-screen bg-gray-50 pb-28">
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-6 py-4 flex space-x-3 z-20 max-w-md mx-auto">
          ...
          <button
            onClick={() => { saveContact(a); navigate(`/app/chat/${a.id}`); }}
